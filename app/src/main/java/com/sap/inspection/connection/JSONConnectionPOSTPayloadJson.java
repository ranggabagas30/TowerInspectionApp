...
public class JSONConnectionPOSTPayloadJson extends AsyncTask<Void, Void, String>{
	...
	public JSONConnectionPOSTPayloadJson(Context context, String url,Handler handler,String json) {
		this.json = json;
		this.url = url;
