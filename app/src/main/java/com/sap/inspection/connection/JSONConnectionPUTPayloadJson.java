...
public class JSONConnectionPUTPayloadJson extends AsyncTask<Void, Void, String>{
	...
	public JSONConnectionPUTPayloadJson(Context context, String url,Handler handler,String json) {
		this.json = json;
		this.url = url;
